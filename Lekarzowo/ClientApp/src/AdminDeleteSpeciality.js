...
class AdminDeleteSpeciality extends React.Component {
constructor(props){
  super(props);
  this.state = {
    loading: false,
...
handleClickDelete(event){
  this.setState ({
    errors: Validation.validateUniversalNumberBlank(this.state.selectedObjectId, "Specjalizacja")
  }, () => {
    ...
    if(Object.keys(this.state.errors).length > 0){
      ...
      AdminService.deleteSpeciality(this.state.selectedObjectId)
      .then(response => {
        this.setState({
...
render() {
  return(
    <div className = 'admin-content-holder flex-column' >
      <a className = 'subheader-content-profile'>Usuń Specjalizację</a>
...
export default AdminDeleteSpeciality;
