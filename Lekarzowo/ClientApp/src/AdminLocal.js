...
import AdminShowLocals from './AdminShowLocals.js';

class AdminLocal extends React.Component {
constructor(props){
  super(props);
  this.state = {
    currentPage:  "add"
...
showContent(){
  switch(this.state.currentPage){
    case 'add':
      ...
      break;
    case 'edit':
      return <AdminEditLocal />
      break;
    case 'delete':
      return <AdminDeleteLocal />
      break;
    case 'show':
      return <AdminShowLocals />
      break;
