...
class AdminDeleteSickness extends React.Component {
constructor(props){
  super(props);
  this.state = {
    loading: false,
...
handleClickDelete(event){
  this.setState ({
    errors: Validation.validateUniversalNumberBlank(this.state.selectedObjectId, "Choroba")
  }, () => {
    ...
    if(Object.keys(this.state.errors).length > 0){
      ...
      AdminService.deleteSickness(this.state.selectedObjectId)
      .then(response => {
        this.setState({
...
render() {
  return(
    <div className = 'admin-content-holder flex-column' >
      <a className = 'subheader-content-profile'>Usuń Chorobę</a>
...
export default AdminDeleteSickness;
