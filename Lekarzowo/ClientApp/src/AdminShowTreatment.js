...
class AdminShowTreatment extends React.Component {
constructor(props){
  super(props);
  this.state = {
    list: [],
...
render() {
  return(
    <div className = 'admin-content-holder flex-column' >
      <a className = 'subheader-content-profile'>Lista Zabiegów</a>
      <div className = 'flex-column width-100'>
        <div className = 'flex-column width-100'>
          <div className = 'sickness-item'>
            <div className = 'sickness-item-part part-1-2-3'>
              <a className = 'table-header'>Zabieg</a>
            </div>
...
export default AdminShowTreatment;
